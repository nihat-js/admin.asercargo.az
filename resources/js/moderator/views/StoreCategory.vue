  ...
  export default {
    ...
    methods: {
      initialize () {
        ...
        axios.get('/moderatorAPI/showStoreCategory' + '?name=' + this.search.name + '&page=' + this.pagination.current).
          then((resp) => {
        ...
        this.$validator.validateAll().then(responses => {
          if (responses) {
            if (this.editedIndex > -1) {
              ...
              axios.post('/moderatorAPI/updateStoreCategory', formData).then((resp) => {
              ...
              axios.post('/moderatorAPI/createStoreCategory', formData).then((resp) => {
                if (resp.data.case === 'success') {
                  _this.initialize()
                  _this.close()
                }
      ...
      deleteItem (item) {
        ...
        Swal.fire({
          ...
          if (result.value) {
            axios.delete('/moderatorAPI/deleteStoreCategory/' + item.id).then((resp) => {
