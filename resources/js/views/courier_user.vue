            ...
            <v-col cols="12">
              <v-row justify="center">
                ...
                >
                  ...
                  Set Courier to Selected Orders
                </v-btn>
                <!-- <v-btn
                  class="ma-3"
                  :loading="loading"
          ...
          <template v-slot:item="{ isSelected, select, item }">
            <tr :class="item.urgent ? 'urgent' : ''">
              ...
              <td>
                <div class="action">
                  <div>
                    <v-icon small @click="showPackages(item)">
                      mdi-eye
                    </v-icon>
                  </div>
                  <div>
                  ...
                  <!-- <div>
                    <v-icon small :disabled="!printer" @click="printBill(item)">
                      mdi-printer
                    </v-icon>
                  </div> -->
                </div>
      ...
      <v-row justify="center">
        <v-dialog v-model="dialogCourier" max-width="700">
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="green darken-1" text @click="dialogCourier = false"
                >close</v-btn
              >
              <v-btn
        ...
        await axios
          ...
          .then((resp) => {
            if (resp.data.case === 'success') {
              ...
              // setTimeout(()=>{},iS*3)
              this.download('EDI-Team-2019-Colibri-Courier.txt', txt)
