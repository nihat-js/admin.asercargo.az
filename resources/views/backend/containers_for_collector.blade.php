...
@section('actions')
    <li>
        <a class="action-btn" onclick="del('{{route("delete_container_collector")}}')"><span
...
@section('content')
    ...
    <div class="dol-md-12">
            ...
            <div class="references-in">
                <table class="references-table">
                    ...
                    <tr>
                        ...
                        <th class="columns" onclick="sort_by('flt.awb')">AWB</th>
                        ...
                        <tr class="rows" id="row_{{$container->id}}" onclick="select_row({{$container->id}})">
                            ...
                            <td>
                                <span class="btn btn-primary btn-xs"
                                      onclick="print_container('{{$container->id}}', '{{$container->awb}}', '{{$container->airline}} {{$container->flight_number}}', '{{$container->dep}}', '{{$container->des}}');"><i
       ...
       {{-- <div class="col-md-4" style="background-color: #f8ffc2;">
            <form id="form" class="add_or_update_form" action="{{route("add_container_collector")}}" method="post">
                {{csrf_field()}}
                <div class="form row">
                    <div class="col-md-6">
                        <p class="name">
